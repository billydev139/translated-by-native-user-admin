...
const Notification = ({ id, subject, message, time, status, icon }) => {
  return (
    <>
    <div className="bg-white hover:bg-gray-4 flex justify-between p-4 mb-4 rounded shadow-card cursor-pointer">
      ...
      <div className="flex gap-8 w-11/12">
        ...
        <div className="flex flex-col">
          <p className="text-sm xl:text-base 2xl:text-lg 3xl:text-xl font-semibold">{id}. {subject} </p>
